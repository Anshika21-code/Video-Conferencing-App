  ...
  return (
    <div>
      <div className='flex min-h-screen bg-gradient-to-r from-blue-100 to-purple-200 dark:from-gray-900 dark:to-gray-800'>
         <div className='hidden w-1/2 bg-gray-100 lg:blockk'>
              <Image
         ...
         <div className='max-w-md mx-auto'>
          ...
          <div className='space-y-4'>
            <Button className="w-full dark:hover:bg-white dark:hover:text-black" variant="outline">
            <svg
          ...
          <div className="flex flex-col space-y-4 mt-6">
            <div className="relative w-full">
              ...
              <Button className="w-full bg-black text-white dark:bg-white dark:hover:bg-gray-200 dark:text-black" variant ="ghost" >
